...
=======
Refined repository presentation and removed internal artifacts.
### Removed
- Internal configuration file removed from public repository.
...
=======
- `examples/redacted-error-handler.json`: Structural example of the error handler workflow. Covers failure capture, error classification, Path A catalog lookup, Path B AI-assisted repair, contract validation before re-execution, catalog promotion, escalation, and observability emission.
>>>>>>> 421a0ce6258687ef4d2cea57badc917fb0f5eb8a
...
### Added
- Registry-as-SSOT pattern: centralized configuration layer with routing, workflow, credential, and error type registries
>>>>>>> 421a0ce6258687ef4d2cea57badc917fb0f5eb8a
...
- Initial repository structure
- `architecture/overview.md`: Core architecture overview
- `examples/redacted-orchestrator-workflow.json`: Orchestrator structural example
- `examples/redacted-workflow.json`: Domain agent structural example
- `examples/redacted-agent-contract.yaml`: Agent contract structural example
>>>>>>> 421a0ce6258687ef4d2cea57badc917fb0f5eb8a
